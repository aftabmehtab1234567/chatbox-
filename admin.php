        ...
        <div class="row">
                            ...
                            while ($data = mysqli_fetch_array($res)) {?>
                                <div class="row  bg-light">
                                    <div class="col text-center">
                                        <img src=<?= $data['image'] ?>
                                        alt="Profile Image" class="rounded-circle" height="80px" width="100px">
                                    </div>
                                    <div class="col">
                                        <div class="name"> <?= $data['firstname'] ?></div>
                                        <div class="name"> <?= $data['email'] ?></div>
                                        <div class="d-flex">
                                            <button id="" class="btn btn-success rounded-pill " onclick=" myFunction()" >showMessage</button>
            ...
            ?>
                        ...
                        <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0 text-center"> 
                            <div class="border border-primary rounded messageArea  "id="myDIV" style="display: none;">
                                <div class="message-area" >
                                    <div class="message user-message text-start mx-5 bg-dark text-white rounded-pill">Hi</div>
                                </div>
                                <div class="mt-5">
                                    <input type="text" id="userInput" placeholder="Type your message..." class="rounded-pill">
