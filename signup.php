            ...
            <div class="col-lg-3 m-auto main-form">
                <form action="phpcode.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="exampleInputPassword1" placeholder="Enter your Email" name="email" required="">
                    ...
                    <div class="mb-3">
                        <input type="submit" value="SIGN IN" class="form-control mt-4 sign-btn" name="save" id="exampleInputPassword1">
                    </div>
